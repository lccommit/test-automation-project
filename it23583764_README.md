...
This project tests the accuracy of the **Chat Sinhala transliteration** function available at [pixelssuite.com/chat-translator](https://www.pixelssuite.com/chat-translator).
...
|Column|Description|
|-|-|
|TC ID|Test case ID (Neg\_0001 - Neg\_0050)|
